...
data:
  ...
  bundledCode: "#line 2 \"library/graph/base/edge.hpp\"\nstruct Edge {\n  int from,\
    ...
    \ &&[from, to, cost, idx] : G[p.first]) {\n        if (to != p.second) sz[p.first]\

...
data:
  ...
  bundledCode: "#line 2 \"library/various/random.hpp\"\n#include <chrono>\n#include\
    ...
    \          next_node = fail_link;\n                }\n            }\n        }\n\
    \    }\n    // \u6B21\u306E\u72B6\u614B\u3078\u9077\u79FB\n    int next(int now,\
    \ char c) const { return nodes[now].nxt[c - margin]; }\n    // \u6587\u5B57\u5217\
    \u5168\u4F53\u3092\u8D70\u67FB\u3057\u3066\u7DCF\u30D2\u30C3\u30C8\u6570\u3092\

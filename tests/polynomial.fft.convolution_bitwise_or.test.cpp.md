...
data:
  ...
  attributes:
    ...
    document_title: "Bitwise\u7573\u307F\u8FBC\u307FOR\u306E\u30C6\u30B9\u30C8"
    links:
...
layout: document
redirect_from:
- /verify/tests/polynomial.fft.convolution_bitwise_or.test.cpp
- /verify/tests/polynomial.fft.convolution_bitwise_or.test.cpp.html

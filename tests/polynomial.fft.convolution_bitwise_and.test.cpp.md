...
data:
  ...
  attributes:
    ...
    document_title: "Bitwise\u7573\u307F\u8FBC\u307FAND\u306E\u30C6\u30B9\u30C8"
    links:
  ...
  code: "#define PROBLEM \"https://judge.yosupo.jp/problem/bitwise_and_convolution\"\
    ...
    \ a(1 << N), b(1 << N);\n    cin >> a;\n    cin >> b;\n    auto c = convolution_bitwise_and(a,\
    \ b);\n    print(c);\n}\n"
  dependsOn:
...
layout: document
redirect_from:
- /verify/tests/polynomial.fft.convolution_bitwise_and.test.cpp
- /verify/tests/polynomial.fft.convolution_bitwise_and.test.cpp.html

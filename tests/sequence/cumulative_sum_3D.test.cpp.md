...
data:
  ...
  code: "#define PROBLEM                                                         \
    ...
    \ A(X, vector<vector<int>>(Y, vector<int>(Z, 1)));\n        \n        auto S =\
    \ cumulative_sum_3D(A);\n\n        // \u30B5\u30A4\u30BA\u78BA\u8A8D (X+1, Y+1,\
    \ Z+1)\n        assert(S.size() == 3);\n        assert(S[0].size() == 3);\n  \
    \      assert(S[0][0].size() == 3);\n\n        // \u5883\u754C\uFF080\u9762\uFF09\
    \u306F\u3059\u3079\u3066 0 \u3067\u3042\u308B\u3079\u304D\n        assert(S[0][0][0]\
  ...
  - library/sequence/cumulative_sum_3D.hpp
  ...
  verifiedWith: []
documentation_of: tests/sequence/cumulative_sum_3D.test.cpp
layout: document
redirect_from:
- /verify/tests/sequence/cumulative_sum_3D.test.cpp
- /verify/tests/sequence/cumulative_sum_3D.test.cpp.html
title: "3\u6B21\u5143\u7D2F\u7A4D\u548C\u306E\u30C6\u30B9\u30C8"
---

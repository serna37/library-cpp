...
data:
  ...
  - library/sequence/cumulative_sum_rev.hpp
  ...
  verifiedWith: []
documentation_of: tests/sequence/cumulative_sum_rev.test.cpp
layout: document
redirect_from:
- /verify/tests/sequence/cumulative_sum_rev.test.cpp
- /verify/tests/sequence/cumulative_sum_rev.test.cpp.html
title: "\u7D2F\u7A4D\u548C \u53CD\u8EE2\u306E\u30C6\u30B9\u30C8"
---

...
data:
  ...
  - library/sequence/cumulative_sum_2D.hpp
  ...
  verifiedWith: []
documentation_of: tests/sequence/cumulative_sum_2D.test.cpp
layout: document
redirect_from:
- /verify/tests/sequence/cumulative_sum_2D.test.cpp
- /verify/tests/sequence/cumulative_sum_2D.test.cpp.html
title: "2\u6B21\u5143\u7D2F\u7A4D\u548C\u306E\u30C6\u30B9\u30C8"
---

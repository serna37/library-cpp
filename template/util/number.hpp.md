...
data:
  ...
  attributes:
    document_title: "\u6570\u306E\u6027\u8CEA"
    links: []
  bundledCode: "#line 2 \"template/util/number.hpp\"\n/**\n * @brief \u6570\u306E\u6027\
    \u8CEA\n */\nclass Number {\n  private:\n    // mod\u968E\u4E57\u306E\u30E1\u30E2\
    ...
    \ ^ b) > 0 and a % b != 0) ? 1 : 0);\n    }\n    // \u5272\u308A\u4E0A\u3052\uFF08\
    \u8CA0\u306E\u5834\u54080\u5074\u3078\u4E38\u3081\u306A\u3044\uFF09\n    long\
    \ long div_floor(long long a, long long b) {\n        return a / b - (((a ^ b)\
    \ < 0 and a % b != 0) ? 1 : 0);\n    }\n    // \u968E\u4E57 \u30CA\u30A4\u30FC\
    ...
    \ (int i = _mf.size(); i <= x; ++i) _mf.push_back(_mf.back() * i % m);\n     \
    \   return _mf[x];\n    }\n    // mod\u7D44\u307F\u5408\u308F\u305BnCk O(log m)\n\
    \    long long mod_combination(int n, int k, long long m) {\n        return modfact(n,\
    \ m) * modinv(modfact(k, m), m) % m *\n               modinv(modfact(n - k, m),\
    \ m) % m;\n    }\n};\n"
  code: "#pragma once\n/**\n * @brief \u6570\u306E\u6027\u8CEA\n */\nclass Number\
    \ {\n  private:\n    // mod\u968E\u4E57\u306E\u30E1\u30E2\u914D\u5217\n    vector<long\
    \ long> _mf;\n\n  public:\n    // \u5272\u308A\u4E0B\u3052\uFF08\u8CA0\u306E\u5834\
    ...
    \ modpow(a, m - 2, m);\n    }\n    // mod\u968E\u4E57 O(N)\n    long long modfact(int\
    \ x, long long m) {\n        if ((int)_mf.size() > x) return _mf[x];\n       \
    \ if (_mf.empty()) _mf.push_back(1);\n        for (int i = _mf.size(); i <= x;\
    \ ++i) _mf.push_back(_mf.back() * i % m);\n        return _mf[x];\n    }\n   \
  ...
  - tests/util.test.cpp
documentation_of: template/util/number.hpp
layout: document
redirect_from:
- /library/template/util/number.hpp
- /library/template/util/number.hpp.html
title: "\u6570\u306E\u6027\u8CEA"
---
